...
1. **0:00–0:20 — Product framing:** Show the empty or populated Flights timeline and explain that every row is private through Supabase RLS.
2. **0:20–0:55 — Search:** Enter a flight number and departure date, submit once, and point out the normalized provider result.
...
5. **1:55–2:30 — Insights:** Show totals, the route map or web fallback, rankings, and a yearly recap.
